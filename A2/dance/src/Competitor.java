...
public class Competitor {
    ...
    public double getTotalDanceScore() {
        double pop_weight_avg = competition.getPoppingDanceFraction() * (poppingDanceScores.getCalibratedAverage());
        double hiphop_weight_avg = competition.getHipHopFraction() * (hipHopDanceScores.getCalibratedAverage());
        return pop_weight_avg + hiphop_weight_avg;
    }
